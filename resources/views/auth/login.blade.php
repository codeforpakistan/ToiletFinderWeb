...
<head>
    ...
    <title>Public Toilet Finder | PTF</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo"><a href="."><b>Public Toilet </b>Finder</a></div>
        <!-- /.login-logo -->
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                {!! old('remember') ? Form::checkbox('remember', '1') : Form::checkbox('remember', '1', ['checked' => 'checked']) !!} Remember Me
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
